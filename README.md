# Authentic Emojis for LinkedIn Posts
...
Since this extension is sideloaded, you can easily install it in Chrome Developer Mode.

1. **Download the Repository:** Clone or download this repository to your local computer.
2. **Setup and Build:** 
   ...
   npm run build
   ```
3. **Open Chrome Extensions:** Open Google Chrome and navigate to `chrome://extensions/` in your address bar.
...
6. **Select Directory:** Browse and select the `dist` folder located inside this project directory.
7. **Ready to go!** the extension is now installed. Pin the icon to your toolbar, navigate to your LinkedIn feed, and start reacting!
